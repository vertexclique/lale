...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Videos page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
