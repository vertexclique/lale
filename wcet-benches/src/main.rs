...
use wcet_benches::{BenchmarkResult, BenchmarkRunner};
...
enum Commands {
    ...
    Run {
        ...
        #[arg(
            short,
            long,
            default_value = "../config/platforms/stm32f746-discovery.toml"
        )]
        platform: String,
...
fn run_benchmarks(platform: String, ir_dir: PathBuf, specific_benchmark: Option<String>) {
    ...
    for ir_file in &ir_files {
        ...
        if result.success {
            ...
            print!(
                "  Blocks: {}, Edges: {}",
                result.details.basic_blocks, result.details.cfg_edges
            );
