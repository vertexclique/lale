...
export default function Analytics() {
  return (
    <>
      <PageMeta
        title="React.js Analytics Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Analytics Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
