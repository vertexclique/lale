...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="React.js Basic Tables Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Basic Tables Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
