...
export default function Marketing() {
  return (
    <>
      <PageMeta
        title="React.js Marketing Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Marketing Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
