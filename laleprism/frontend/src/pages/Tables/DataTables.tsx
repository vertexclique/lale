...
export default function DataTables() {
  return (
    <>
      <PageMeta
        title="React.js Data Tables Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Data Tables Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
