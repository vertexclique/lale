...
export default function Dropdowns() {
  return (
    <div>
      <PageMeta
        title="React.js Dropdowns Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Dropdowns Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
