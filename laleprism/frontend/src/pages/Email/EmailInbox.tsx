...
export default function EmailInbox() {
  return (
    <>
      <PageMeta
        title="React.js Inbox Dashboard | LALE Prism - React.js Admin Dashboard Template"
        description="This is React.js Inbox Dashboard page for LALE Prism - React.js Tailwind CSS Admin Dashboard Template"
      />
